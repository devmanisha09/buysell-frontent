...
export class PsValueHolder {
    ...
    userPassword : string = '';
    languageCode : string = PsConfig.defaultLanguage.languageCode;
    showProfile : string = PsConfig.showUserProfile;
    ...
    loadData() {
        ...
        this.notiSetting = localStorage.notiSetting ?? PsConfig.enableNotification;
        ...
        this.showProfile = localStorage.showProfile ?? PsConfig.showUserProfile;
    }
