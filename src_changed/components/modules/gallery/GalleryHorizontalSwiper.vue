    ...
    <div class='overflow: hidden;' >
        ...
        <div v-else>
            <swiper
                ...
                :space-between="14"
                @slideChange="onSlideChange">
                    <swiper-slide class='swiper-slide bg-background dark:bg-backgroundDark' v-for="gallery in galleryList" :key="gallery.imgId" >
                        <gallery-horizontal-item :gallery="gallery" @click="imgClicked(gallery)" />
                    </swiper-slide>
            ...
            <swiper
                ...
                :space-between="14"
                @slideChange="onSlideChange">
                    <swiper-slide class='swiper-slide' v-for="gallery in galleryList" :key="gallery.imgId" >
                        <gallery-horizontal-item :gallery="gallery" @click="imgClicked(gallery)" />
                    </swiper-slide>
            </swiper>
        </div>
