...
export class RecentItemProvider extends PsProvider {
    ...
    id: string = "";
    paramHolder = reactive<ProductParameterHolder>(new ProductParameterHolder().getRecentParameterHolder());
...
export const recentItemProviderSymbol = Symbol('RecentItemProvider')
export const createRecentItemProviderState = () => {
    return reactive(new RecentItemProvider())
}

export const useRecentItemProviderState = () => inject(recentItemProviderSymbol) as RecentItemProvider
export const provideRecentItemProviderState = () => provide(
    recentItemProviderSymbol,
    createRecentItemProviderState()
)