...
export default class PsApiService extends PsApi {
    ...
    **/
    ...
    static async postItemImageUpload<T extends PsObject<T>>(obj: T, imgParentId : String,  imgType : String, ordering : Number, imgDesc: String, imageFile : File, imgId : String): Promise<PsResource<T>> {
        
        const url: String = PsUrl.ps_item_image_upload_url;
    ...
    static async postItemVideoUpload<T extends PsObject<T>>(obj: T, imgParentId : String, videoFile : File): Promise<PsResource<T>> {
        const url: String = PsUrl.ps_video_upload_url;
    ...
    static async postItemVideoThumbUpload<T extends PsObject<T>>(obj: T, imgParentId : String, videoThumbFile : File): Promise<PsResource<T>> {
       
        const url: String = PsUrl.ps_video_thumb_upload_url;
    ...
    /// Item Entry
    ///
    static async postItemEntry<T extends PsObject<T>>(obj: T, postData: any): Promise<PsResource<T>> {
        return await PsApi.postData<T, T>(obj, PsUrl.ps_item_entry_url, postData);
