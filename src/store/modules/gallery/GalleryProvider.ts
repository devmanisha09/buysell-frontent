...
export class GalleryProvider extends PsProvider {
    ...
    async loadGalleryList(imgParentId : string, imgType : string, videoThumbnail : DefaultPhoto) {
        ...
        if( PsConfig.isEnableVideoSetting && videoThumbnail != null && videoThumbnail != undefined &&  videoThumbnail.imgId != '' && videoThumbnail.imgId != undefined ) {
