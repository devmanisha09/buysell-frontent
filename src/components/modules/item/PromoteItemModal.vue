       ...
       <ps-modal ref="psmodal" line="hidden" maxWidth="480px" :isClickOut='false' class='h-full  ' bodyHeight="max-h-72" theme="p-6 border lg:rounded-2xl rounded-xl "> 
        ...
        <template #footer>    
            ...
            <div class="px-8 flex flex-row justify-between">
                <ps-button class=" sm:w-24 w-20  py-3" @click="paypalClicked" >{{ $t('promote_item_modal__pay_with_paypal') }}</ps-button>
                <ps-button class="sm:w-24 w-20 py-3" @click="stripeClicked" >{{ $t('promote_item_modal__pay_with_stripe') }}</ps-button>
                <ps-button class=" sm:w-24 w-20 py-3" @click="razorClicked" >{{ $t('promote_item_modal__pay_with_razor') }}</ps-button>                               
            </div>
            <div class="px-8 mt-2 flex flex-row justify-between">
                <ps-button class=" sm:w-24 w-20 py-3 " @click="paystackClicked" >{{ $t('promote_item_modal__pay_with_stack') }}</ps-button>
                <ps-button class=" sm:w-24 w-20 py-3 " @click="offlineClicked" >{{ $t('promote_item_modal__pay_with_offline') }}</ps-button>
