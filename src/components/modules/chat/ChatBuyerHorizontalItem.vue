        ...
        <ps-card class="h-22 sm:h-24  " :enabledHover="true">
            ...
            <div class="flex flex-row items-center w-full justify-end " >
                <div class="flex-grow w-full justify-start flex flex-row">
                    <div class=" lg:px-3 py-3 sm:px-2 px-1">
                        <img alt="Placeholder" width="400" height="400" class="rounded-full bg-transparent lg:w-14 lg:h-14 w-11 h-11  flex object-cover" :src="chathistorylistProvider.imageUrl(chathistory ? chathistory.buyer.userProfilePhoto : '',2)" @error="chathistorylistProvider.defaultProfileImage" >
                    </div>
                    <div class="flex flex-col lg:ms-2 ms-1 my-auto">
                        <div class=" flex mt-1"> 
                            <ps-label class="font-medium text-sm lg:text-base"> {{chathistory ? chathistory.buyer.userName : ''}} </ps-label>
                ...
                <div class="hidden sm:flex ms-4 lg:ms-8 flex-col w-36 lg:w-40 ">
                    ...
                    <div class="flex flex-col">
                        <ps-label class="text-sm font-medium text-center flex-shink-0 mx-auto" textColor="text-primary-500 dark:text-primaryDark-accent" > {{chathistory ? chathistory.sellerUnreadCount : '0'}}  </ps-label>
                        <div v-if="chathistory?.sellerUnreadCount != '1'">
            ...
            <div class="sm:hidden flex-row flex justify-between">
                <div class="flex flex-row ">
                    <div class="flex flex-row">
                        <ps-label class="text-sm font-medium text-center mx-2" textColor="text-primary-500 dark:text-primaryDark-accent" > {{chathistory ? chathistory.buyerUnreadCount : '0'}} </ps-label>
