    ...
    <div>
        <div class=" sm:mt-32 lg:mt-36 mt-28  flex flex-col">
            ...
            <div class="w-55 lg:w-80 flex flex-col mx-auto rounded-lg">
                ...
                <ps-button textSize="text-xs lg:text-base" class="mt-3 lg:mt-4 py-3 flex justify-center mb-5" theme="bg-yellow-600 hover:bg-yellow-700 text-textLight px-4 py-2"  id="signinBtn" @click="googleloginclicked">  
