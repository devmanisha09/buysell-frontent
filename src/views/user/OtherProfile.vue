                        ...
                        <div  class="w-1/2 sm:w-full">
                            ...
                            <div class="lg:mt-2 mt-1.5 flex justify-between">
                                ...
                                <div v-if="userProvider.user.data?.isFollowed == '0'">
                                    <ps-button rounded="rounded-2xl" textSize="text-xxs lg:text-xs" class=" w-full  mx-auto" > Follow </ps-button>
                                </div>
                                <div v-else-if="userProvider.user.data?.isFollowed == '1'">
                                    <ps-button rounded="rounded-2xl" textSize="text-xxs lg:text-xs" class=" w-full  mx-auto" > Unfollow </ps-button>
                                </div>
                            </div>
