<template>
    <div>
        ...
        <div class="w-full grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4 mt-2">
            ...
            <!-- Start for video -->
            <div v-if="isVideoSetting ==true" class="px-8 sm:px-0 sm:col-start-2 lg:px-8 lg:col-start-2 col-span-4 sm:col-span-6 lg:col-span-8 w-full rounded-md  dark:-black pt-4">
                <div class="flex flex-auto">
