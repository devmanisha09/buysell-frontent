        ...
        <template #content>
            <div class="sm:mt-32 lg:mt-36 mt-28 mb-16 ">
                ...
                <div class="flex flex-col items-start mt-8">
                    <ps-label-header-4 class=" mb-4 font-medium"> {{ $t("reject_item_list__reject_item_list") }} </ps-label-header-4>
                    ...
                    <div class=" mb-4 flex items-center mt-8"> 
                        ...
                        <ps-label class="font-light"> {{ $t("reject_item_list__reject_item_list") }} </ps-label>
                    </div>
                        ...
                        <div class="w-full">
                            ...
                            <div v-if="itemrejectProvider.productList?.data != null">
                                <div class="grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4">
                                    ...
                                    <div class="w-full col-span-2 lg:col-span-3" v-for="item in itemrejectProvider.productList.data" :key="item.id">
