    ...
    <div class="w-mobile sm:w-median lg:w-large mx-auto">
        ...
        <div class="sm:mt-32 lg:mt-36 mt-28">
            ...
            <div class="w-full cursor-pointer" >
                ...
                <div class="z-0" >
                    <gallery-horizontal-swiper :galleryList="galleryProvider.galleryList.data" :isLoading="galleryProvider.galleryList.data == null && dataReady ? false : true" @clickImage="showGalleryDetail" class='z-0' />
                </div>
                <!-- End Gallery Swiper -->
            </div>
            <!-- End item gallery -->
            
            <div class="w-full mt-8 grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4 justify-between container">
                
                <div class="col-span-2 sm:col-span-5  lg:col-span-8 w-full">
                    <div class="flex flex-col w-1/2">
                        <ps-label class="lg:text-2xl sm:text-xl text-lg font-medium" > {{ productProvider.product.data ? productProvider.product?.data?.title : '' }} </ps-label> 
                        <div class=" mt-2">
                    ...
                    <div v-if="loginUserId != productProvider.product?.data?.user?.userId" class="flex space-x-3 text-sm font-medium mt-2">
                        ...
                        <ps-route-link class="flex flex-grow" :to="{ 
                            ...
                            query: { 
                                ...
                                item_price : productProvider.product?.data?.price,
            ...
            <div class="w-full grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-x-4 sm:gap-x-3.5 lg:gap-x-4 justify-between container">
                ...
                <div class="col-span-4 sm:col-span-5  lg:col-span-8 w-full">
                    ...
                    <div class="w-full my-6">
                        <ps-label class="px-5 lg:text-sm text-xs font-medium" > {{ productProvider.product.data ? productProvider.product?.data?.highlightInformation : '' }} </ps-label>
                    </div>
                    ...
                    <div class="my-2 mt-4 p-4 bg-primary-000 dark:bg-primaryDark-black lg:rounded-2xl sm:rounded-xl rounded-x">
                        ...
                        <ps-label class="p-2 lg:text-sm text-xs font-light" > {{ showSafetyTip ? aboutUsProvider.aboutus?.data?.safetyTips : aboutUsProvider.aboutus?.data?.safetyTips.slice(0,175)+'....' }} </ps-label>
                    ...
                    <div class="hidden md:block">
                        <ps-ad-sense adStyle="display:inline-block;width:728px;height:90px" adFormat="horizontal"></ps-ad-sense>
                    </div>
                ...
                <div class="col-span-4 sm:col-span-3  lg:col-span-4 w-full">
                    ...
                    <div v-if="productProvider.product?.data" class="mt-2 mb-4 p-4 lg:rounded-2xl rounded-xl bg-primary-000 dark:bg-primaryDark-black">
                        ...
                        <ps-label class="font-light lg:text-sm text-xs my-2" > {{ productProvider.product?.data?.address }} </ps-label>

                        <map-with-pin-picker :lat="parseFloat(productProvider.product?.data?.lat + '')" :lng="parseFloat(productProvider.product?.data?.lng + '')" :draggable="false" />
                    </div>
...
export default {
    ...
    setup() {
        ...
        async function loadDataForItemDetail() {
            ...
            await galleryProvider.loadGalleryList(itemId,PsConst.ITEM_TYPE, productProvider.product?.data.videoThumbnail);
