        ...
        <template #content>
            <div class="sm:mt-32 lg:mt-36 mt-28 mb-16 ">
                ...
                <div class="flex flex-col items-start">
                    <ps-label-header-4 class=" mb-4 font-medium"> {{ $t("reported_item_list__reported_item_list") }} </ps-label-header-4>
                    <ps-label > {{ $t("reported_item_list__text") }}</ps-label>
                        ...
                        <div class="w-full">
                            <div v-if="reporteditemProvider.reportedReportedItemList?.data != null">
                                <div class="grid lg:grid-cols-12 sm:grid-cols-8 grid-cols-4  gap-4 sm:gap-3.5 lg:gap-4">
                                    ...
                                    <div class="w-full col-span-2 lg:col-span-3" v-for="item in reporteditemProvider.reportedReportedItemList.data" :key="item.id">
