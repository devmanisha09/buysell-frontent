...
module.exports = {
    ...
    devServer: {
        ...
        // Server
        // proxy: 'https://www.panacea-soft.com/flutter-buysell-demo'
        // proxy: 'https://sbmstore.in/backend'
    ...
    configureWebpack: {
        ...
        plugins: [
            new CompressionWebpackPlugin(),
            //new SitemapPlugin({ base: 'https://sbmstore.in', paths, options: {
             new SitemapPlugin({ base: 'http://localhost:3000/', paths, options: {
                skipgzip: true,
